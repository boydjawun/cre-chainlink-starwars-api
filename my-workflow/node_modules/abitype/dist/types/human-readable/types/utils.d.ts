import type { AbiParameter, AbiStateMutability, AbiType, SolidityFixedArrayRange } from '../../../../src/abi.js';
import type { ResolvedRegister } from '../../../../src/register.js';
import type { Error, IsUnknown, Merge, Pretty, Trim } from '../../../../src/types.js';
import type { ErrorSignature, EventModifier, EventSignature, FallbackSignature, FunctionModifier, FunctionSignature, IsConstructorSignature, IsErrorSignature, IsEventSignature, IsFunctionSignature, Modifier, ReceiveSignature, Scope, ValidateName } from '../../../../src/human-readable/types/signatures.js';
import type { StructLookup } from '../../../../src/human-readable/types/structs.js';
