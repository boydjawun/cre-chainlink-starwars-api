...
import { type HexToBigIntErrorType, type HexToNumberErrorType } from '../../../utils/encoding/fromHex.js';
import { type FromRlpErrorType } from '../../../utils/encoding/fromRlp.js';
import type { RecursiveArray } from '../../../utils/encoding/toRlp.js';
import { type AssertTransactionEIP1559ErrorType, type AssertTransactionEIP2930ErrorType, type AssertTransactionEIP4844ErrorType, type AssertTransactionEIP7702ErrorType, type AssertTransactionLegacyErrorType } from '../../../utils/transaction/assertTransaction.js';
import { type GetSerializedTransactionType, type GetSerializedTransactionTypeErrorType } from '../../../utils/transaction/getSerializedTransactionType.js';
...
export declare function toTransactionArray(serializedTransaction: string): import("../../../utils/encoding/fromRlp.js").FromRlpReturnType<"hex">;
