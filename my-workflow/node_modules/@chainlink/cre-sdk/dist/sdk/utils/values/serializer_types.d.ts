...
export type CreSerializable<T> = T extends PrimitiveTypes ? T : T extends Function ? never : T extends NonSerializable ? never : T extends any[] ? CreSerializableNested<T[number]>[] : T extends object ? {
    [K in keyof T]: CreSerializableNested<T[K]>;
} : never;
